...
- Docker compose and docker is installed on the computer.
- Git for cloning project
- Optional but recommended is to have docker desktop installed. 

## quick-start guide.

Any terminal can be used to access the project folder using 
```
